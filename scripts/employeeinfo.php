...
Display information about a specific employee including office hours and possibly teaching duties
-->
...
// get all information about specific employee
$query = "select * from employee where id = '$post_info'";
...
echo "<tr><td>Website: </td><td><a target=_blank href=\"$website\">$website</a>"."</td></tr>\n";
echo "<tr><td>Position: </td><td>".ucwords($pos)."</td></tr>\n";
echo "<tr><td colspan=2 align=center>Office Hours</td></tr>\n";

// now we have to do a 'hack' to show the office hours in order by day
...
// now we are going to show teaching duties
